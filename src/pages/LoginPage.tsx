...
function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError('Invalid admin credentials. Use admin@havenaid.org / admin123');
  };
    ...
    <div className="mx-auto flex min-h-[calc(100vh-160px)] max-w-5xl items-center justify-center px-4 py-12 sm:px-6">
      <div className="w-full max-w-xl rounded-[30px] border border-slate-200 bg-white p-8 shadow-[0_25px_70px_rgba(15,23,42,0.08)]">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-4xl font-black text-slate-900">Sign in to HavenAid</h1>
          <p className="mt-3 text-sm text-slate-500">Demo credentials: admin@havenaid.org / admin123</p>
        </div>
